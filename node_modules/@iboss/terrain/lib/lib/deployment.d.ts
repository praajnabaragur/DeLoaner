...
export declare const storeCode: ({ conf, noRebuild, contract, signer, network, refsPath, lcd, codeId, }: StoreCodeParams) => Promise<any>;
...
export declare const instantiate: ({ conf, refsPath, network, lcd, signer, admin, contract, codeId, instanceId, }: InstantiateParams) => Promise<void>;
